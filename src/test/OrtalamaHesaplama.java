...
public class OrtalamaHesaplama {
	...
	int ogrenciNumarasý = kullaniciDegerAl.nextInt();
	...
	double ortalama = (vizeNotu*0.3) + (finalNotu*0.7);
	 ...
	 System.out.printf("Adi %s olan ogrenci numarasi %d olan kisinin not ortalamasi %f",adSoyad,ogrenciNumarasý,ortalama);
